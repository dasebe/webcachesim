...
void AdaptSize::update(candidate_t id, const parser::Request& req) {
  reconfigure();
...
void AdaptSize::replaced(candidate_t id) {
...
candidate_t AdaptSize::rank(const parser::Request& req) {
  return list.back();
}

void AdaptSize::dumpStats(cache::Cache* cache) {
